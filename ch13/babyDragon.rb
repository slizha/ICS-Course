...
puts 'Would you like to feed, walk, rock, toss, or put to bed your dragon? Type exit to exit'
resp = gets.chomp
while resp != 'exit'
  if resp == 'feed'
    dragon.feed
    ...
    dragon.walk
  elsif resp == 'put to bed'
    dragon.put_to_bed
  else
    puts 'Please type "feed", "walk", "rock", "toss", "put to bed", or "exit"'
  end
  resp = gets.chomp
end
puts 'Goodbye!'
